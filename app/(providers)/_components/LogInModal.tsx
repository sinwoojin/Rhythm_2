  ...
  return (
    <>
      ...
      {isModal && (
        ...
        >
          <div
            className="absolute top-[50%] left-[50%] w-[500px] h-[530px] bg-[#121212] -translate-x-[50%] -translate-y-[50%] rounded-2xl bg-white"
          ...
          >
            ...
            >
              ...
              <button className="border border-black bg-[#121212] text-white w-[400px] h-[60px] mt-20 hover:-translate-y-2 transition-all">
                로그인하기
              </button>
            </form>
          </div>
