...
function SIgnUpForm() {
  ...
  return (
    <div className="bg-rhythmBlack bg-opacity-95  w-[calc(100%-245px)] ml-[245px] grid place-content-center min-h-[calc(100vh-87px)]">
      <form
        onSubmit={handleSubmitSignUp}
        className="px-10 py-10 rounded-md items-center  bg-rhythmBlack w-[800px]"
      >
